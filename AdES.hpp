...
public:
	...
	HRESULT Verify(const char* data, DWORD sz, CLEVEL& lev,const char* omsg = 0,DWORD len = 0,std::vector<char>* msg = 0,std::vector<PCCERT_CONTEXT>* Certs = 0);
	HRESULT VerifyB(const char* data, DWORD sz, int sidx = 0,bool Attached = true);
